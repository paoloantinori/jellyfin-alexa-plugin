...
- Name: Plugin health checks >> plugin configuration API returns valid config
- Location: /home/pantinor/data/repo/personal/jellyfin-alexa-plugin/tests/ui/plugin-health.spec.ts:68:7
...
Received: false
    ...
    at /home/pantinor/data/repo/personal/jellyfin-alexa-plugin/tests/ui/plugin-health.spec.ts:69:19
```
