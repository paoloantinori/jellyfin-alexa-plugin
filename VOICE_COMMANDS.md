...
| Add Song To Playlist | `أضف الأغنية {song_query}` · `أضف إلى قائمة التشغيل {playlist_target}` |
...
| Add Song To Playlist | `Füge das Lied {song_query} hinzu` · `Füge zur Playlist {playlist_target} hinzu` · `Füge {song_query} hinzu` |
...
| Add Song To Playlist | `add the song {song_query}` · `add to the playlist {playlist_target}` · `put the song {song_query}` |
...
| Add Song To Playlist | `Añade la canción {song_query}` · `añade a la lista {playlist_target}` · `Añade {song_query}` |
...
| Add Song To Playlist | `Ajoute la chanson {song_query}` · `ajoute à la liste de lecture {playlist_target}` · `Ajoute {song_query}` |
...
| Add Song To Playlist | `गाना {song_query} को जोड़ो` · `प्लेलिस्ट {playlist_target} में जोड़ो` · `{song_query} को जोड़ें` |
...
| Create Playlist | `Crea una playlist chiamata {playlist}` · `Crea una nuova playlist chiamata {playlist}` · `Nuova playlist chiamata {playlist}` · `Crea una playlist {playlist}` · `Crea playlist {playlist}` · `Crea playlist chiamata {playlist}` |
...
| Add Song To Playlist | `曲 {song_query}` · `プレイリスト {playlist_target} に追加して` |
...
| Add Song To Playlist | `Voeg het nummer {song_query}` · `voeg toe aan de afspeellijst {playlist_target}` · `Voeg {song_query}` · `voeg {song_query}` |
...
| Add Song To Playlist | `Adicione a música {song_query}` · `adicione à playlist {playlist_target}` · `Adicione {song_query}` |
