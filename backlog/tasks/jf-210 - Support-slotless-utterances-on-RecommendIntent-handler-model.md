...
## Acceptance criteria
- [ ] Handler gracefully handles missing `media_type` slot (no crash, returns a useful response)
- [ ] Slotless utterances added to all 17 locale models
- [ ] Unit tests cover the missing-slot path
