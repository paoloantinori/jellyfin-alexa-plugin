...
GROUPS = [
    ...
    ("Queue and repeat", [
        ...
        ("AddCurrentToPlaylistIntent", "Add the current song to a playlist", False),
        ("AddSongToPlaylistIntent", "Add a song to a playlist", False),
        ("RemoveCurrentFromPlaylistIntent", "Remove the current song from a playlist", False),
        ("CreatePlaylistIntent", "Create a playlist", False),
    ...
    ("Favorites", [
        ...
        ("RateItemIntent", "Rate what is playing", False),
    ]),
    ("Info and queries", [
    ...
    ("Playback control", [
        ...
        ("AMAZON.RepeatIntent", "Repeat", True),
...
SLOT_HINTS = {
    "en": {
        ...
        "playlist_target": "playlist name", "playlist": "playlist name", "podcast_name": "podcast name",
        "title": "video or movie title", "channel": "channel name",
        "station": "radio station name", "series_name": "series name",
        "episode_position": "position (next, latest)",
        "season_number": "season number", "episode_number": "episode number",
        "chapter_number": "chapter number",
        "star_rating": "number of stars (1 to 5)",
        "direction": "ordinal (first, second)",
        "reminder_duration": "duration (5 minutes, 30 seconds, half an hour)", "reminder_time": "time (7 pm)",
        ...
        "query_type": "tracks or albums", "query": "what to search for", "filter": "filter word (rock, jazz)",
    ...
    "it": {
        ...
        "playlist_target": "nome della playlist", "playlist": "nome della playlist", "podcast_name": "nome del podcast",
        "title": "titolo del video o del film", "channel": "nome del canale",
        "station": "nome della stazione radio", "series_name": "nome della serie",
        "episode_position": "posizione (prossimo, ultimo)",
        "season_number": "numero della stagione",
        "episode_number": "numero dell'episodio",
        "chapter_number": "numero del capitolo",
        "star_rating": "numero di stelle (da 1 a 5)",
        "direction": "ordinale (primo, secondo)",
        "reminder_duration": "durata (5 minuti, 30 secondi, mezz'ora)", "reminder_time": "ora (alle sette)",
        ...
        "query_type": "brani o album", "query": "testo da cercare", "filter": "filtro (rock, jazz)",
    ...
    "de": {
        ...
        "playlist_target": "playlist name", "playlist": "Name der Playlist", "podcast_name": "Name des Podcasts",
        "title": "Titel des Videos oder Films",
        "channel": "Name des Senders", "station": "Name des Radiosenders",
        "series_name": "Name der Serie", "episode_position": "Position (nächste, neueste)",
        "season_number": "Staffelnummer",
        "episode_number": "Episodennummer", "chapter_number": "Kapitelnummer",
        "star_rating": "Sternezahl (1 bis 5)",
        "direction": "Ordinalzahl (erstes, zweites)",
        "reminder_duration": "Dauer (5 Minuten, 30 Sekunden, eine halbe Stunde)",
        ...
        "query_type": "Titel oder Alben", "query": "Suchbegriff", "filter": "Filterwort (Rock, Jazz)",
    ...
    "es": {
        ...
        "playlist_target": "nombre de la lista", "playlist": "nombre de la lista",
        ...
        "series_name": "nombre de la serie", "episode_position": "posición (próximo, último)",
        "season_number": "número de temporada",
        "episode_number": "número de episodio",
        "chapter_number": "número de capítulo",
        "star_rating": "número de estrellas (1 a 5)",
        "direction": "ordinal (primero, segundo)",
        "reminder_duration": "duración (5 minutos, 30 segundos, media hora)",
        ...
        "query_type": "canciones o álbumes", "query": "texto a buscar", "filter": "filtro (rock, jazz)",
    ...
    "fr": {
        ...
        "playlist_target": "playlist name", "playlist": "nom de la playlist", "podcast_name": "nom du podcast",
        "title": "titre de la vidéo ou du film",
        "channel": "nom de la chaîne",
        "station": "nom de la station de radio",
        "series_name": "nom de la série", "episode_position": "position (prochain, dernier)",
        "season_number": "numéro de saison",
        "episode_number": "numéro d'épisode",
        "chapter_number": "numéro de chapitre",
        "star_rating": "nombre d'étoiles (1 à 5)",
        "direction": "ordinal (premier, deuxième)",
        "reminder_duration": "durée (5 minutes, 30 secondes, une demi-heure)",
        ...
        "query_type": "chansons ou albums", "query": "texte à rechercher", "filter": "filtre (rock, jazz)",
    ...
    "pt": {
        ...
        "playlist_target": "nome da playlist", "playlist": "nome da playlist", "podcast_name": "nome do podcast",
        "title": "título do vídeo ou do filme", "channel": "nome do canal",
        "station": "nome da estação de rádio",
        "series_name": "nome da série", "episode_position": "posição (próximo, último)",
        "season_number": "número da temporada",
        "episode_number": "número do episódio",
        "chapter_number": "número do capítulo",
        "star_rating": "número de estrelas (1 a 5)",
        "direction": "ordinal (primeiro, segundo)",
        "reminder_duration": "duração (5 minutos, 30 segundos, meia hora)", "reminder_time": "hora (às sete)",
        ...
        "query_type": "faixas ou álbuns", "query": "texto a procurar", "filter": "filtro (rock, jazz)",
    ...
    "nl": {
        ...
        "playlist_target": "playlist name", "playlist": "naam van de playlist", "podcast_name": "naam van de podcast",
        "title": "titel van de video of film",
        "channel": "naam van het kanaal",
        "station": "naam van het radiostation",
        "series_name": "naam van de serie", "episode_position": "positie (volgende, nieuwste)",
        "season_number": "seizoensnummer",
        "episode_number": "afleveringsnummer",
        "chapter_number": "hoofdstuknummer",
        "star_rating": "aantal sterren (1 tot 5)",
        "direction": "rangtelwoord (eerste, tweede)",
        "reminder_duration": "duur (5 minuten, 30 seconden, een half uur)",
        ...
        "query_type": "nummers of albums", "query": "zoektekst", "filter": "filterwoord (rock, jazz)",
    ...
    "ja": {
        ...
        "playlist_target": "プレイリスト名", "playlist": "プレイリスト名", "podcast_name": "ポッドキャスト名",
        "title": "動画または映画のタイトル", "channel": "チャンネル名",
        "station": "ラジオ局名", "series_name": "シリーズ名", "episode_position": "位置（次、最新）",
        "season_number": "シーズン番号", "episode_number": "エピソード番号",
        "chapter_number": "チャプター番号", "direction": "順序 (最初、次)",
        "star_rating": "星の数 (1〜5)",
        "reminder_duration": "時間（5分、30秒、30分）", "reminder_time": "時刻 (7時)",
        "media_type": "メディアの種類 (音楽、ビデオ)",
        "media_info_type": "情報の種類 (タイトル、アーティスト、アルバム)",
        "browse_category": "カテゴリ (アーティスト、アルバム、映画)",
        "query_type": "トラックまたはアルバム", "query": "検索したい言葉", "filter": "フィルター（ロック、ジャズ）",
    ...
    "hi": {
        ...
        "mood": "मूड (शांत, ऊर्जावान)", "playlist_target": "प्लेलिस्ट का नाम", "playlist": "प्लेलिस्ट का नाम",
        "podcast_name": "पॉडकास्ट का नाम",
        "title": "वीडियो या फिल्म का नाम", "channel": "चैनल का नाम",
        "station": "रेडियो स्टेशन का नाम", "series_name": "सीरीज़ का नाम", "episode_position": "स्थिति (अगला, नवीनतम)",
        "season_number": "सीज़न नंबर", "episode_number": "एपिसोड नंबर",
        "chapter_number": "अध्याय नंबर",
        "star_rating": "स्टार संख्या (1 से 5)",
        "direction": "क्रम (पहला, दूसरा)",
        "reminder_duration": "अवधि (5 मिनट, 30 सेकंड, आधा घंटा)",
        ...
        "query_type": "गाने या एल्बम", "query": "खोजने के लिए शब्द", "filter": "फ़िल्टर (रॉक, जैज़)",
    ...
    "ar": {
        ...
        "playlist_target": "اسم قائمة التشغيل", "playlist": "اسم قائمة التشغيل", "podcast_name": "اسم البودكاست",
        "title": "عنوان الفيديو أو الفيلم", "channel": "اسم القناة",
        "station": "اسم محطة الراديو", "series_name": "اسم المسلسل", "episode_position": "الموضع (التالية، الأحدث)",
        "season_number": "رقم الموسم", "episode_number": "رقم الحلقة",
        "chapter_number": "رقم الفصل",
        "star_rating": "عدد النجوم (1 إلى 5)",
        "direction": "ترتيبي (الأول، الثاني)",
        "reminder_duration": "المدة (5 دقائق، 30 ثانية، نص ساعة)",
        ...
        "query_type": "أغانٍ أو ألبومات", "query": "نص البحث", "filter": "عامل التصفية (روك، جاز)",
