...
public abstract class BaseHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!CrossMedia.PassesCrossMediaWordGuard(slotText, locale, fallbackNoun: "album", logLabel, out _))
        {
            return null;
        }
        ...
        var eligible = CrossMedia.FindBestNonEmbeddedMatch(query, candidates, a => a.Name!, threshold);
