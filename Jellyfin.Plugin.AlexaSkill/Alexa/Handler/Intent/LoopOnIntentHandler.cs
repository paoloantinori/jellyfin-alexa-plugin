...
public class LoopOnIntentHandler : BaseHandler
{
    ...
    public override bool CanHandle(Request request)
    {
        ...
        return intentRequest != null && string.Equals(intentRequest.Intent.Name, IntentNames.AmazonLoopOn, StringComparison.Ordinal);
    }
    ...
    public override async Task<SkillResponse> HandleAsync(Request request, Context context, Entities.User user, SessionInfo session, CancellationToken cancellationToken)
    {
        ...
        Logger.LogDebug("LoopOn: entered, token={Token}, offset={OffsetMs}ms", requestState.Token, requestState.OffsetInMilliseconds);
